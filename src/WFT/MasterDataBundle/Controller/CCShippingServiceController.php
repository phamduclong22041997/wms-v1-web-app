...
class CCShippingServiceController extends BaseController
{
    protected function getBizClass()
    {
        return "\WFT\MasterDataBundle\Biz\CCShippingServiceBiz";
    }

    /**
     * Get Transfer Session
     */
    public function getShippingServiceAction() 
    {
        $resp = new ServerResponse();
        $response = new Response();
        try {
            $cls = $this->getBizClass();
            $data = $cls::getShippingService();
