...
class SourceOfMovingOrder {
    const COLLECTION_NAME = "SourceOfMovingOrder";
    ...
    protected $schema = array(
        'sourcemovingcode'     => null,
        'sourcemovingdescription'     => null,
        'sourcemovingdescription_en'  => null
    );
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['sourcemovingcode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(SourceOfMovingOrder::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}