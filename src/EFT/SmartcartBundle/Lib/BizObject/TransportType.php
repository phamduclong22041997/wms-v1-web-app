...
class TransportType {
    const COLLECTION_NAME = "TransportType";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['transporttypecode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(TransportType::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}