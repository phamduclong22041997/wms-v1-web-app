...
use EFT\ParameterBundle\Lib\BizObject\TransactionTypeOfOperationObject;

class TransactionTypeOfOperationObjectBiz {
    ...
    {
        $bizObject = new TransactionTypeOfOperationObject();
