...
class OperationStatus {
    const COLLECTION_NAME = "ParameterOperationStatus";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['object.code' => $filter[0], 'statuscode.code'=>$filter[1], 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(OperationStatus::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}