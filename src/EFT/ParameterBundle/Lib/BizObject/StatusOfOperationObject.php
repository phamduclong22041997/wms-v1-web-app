...
class StatusOfOperationObject {
    const COLLECTION_NAME = "ParameterStatusOfOperationObject";
    ...
    {
        return MongoDBManager::getCollection(StatusOfOperationObject::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}