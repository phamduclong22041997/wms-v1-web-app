...
class TransactionTypeOfOperationObject {
    const COLLECTION_NAME = "ParameterOperationTransactionType";
    ...
    {
        return [
            'operationobject'       => ['code' => $document->operationobject['code'], $document->operationobject['name']],
            'code'                  => $document->code,
            'name'                  => $document->name
        ];
    }
    ...
    {
        return MongoDBManager::getCollection(TransactionTypeOfOperationObject::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}