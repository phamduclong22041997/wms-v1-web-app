...
class ProductConfigurationAttachedService {
    const COLLECTION_NAME = "ProductConfigurationAttachedService";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['servicecode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(ProductConfigurationAttachedService::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}