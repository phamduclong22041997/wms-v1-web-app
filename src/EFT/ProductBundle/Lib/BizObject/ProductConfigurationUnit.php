...
class ProductConfigurationUnit {
    const COLLECTION_NAME = "ProductConfigurationUnit";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['unitcode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(ProductConfigurationUnit::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}