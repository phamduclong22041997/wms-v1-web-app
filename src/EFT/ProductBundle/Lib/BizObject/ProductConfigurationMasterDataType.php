...
class ProductConfigurationMasterDataType {
    const COLLECTION_NAME = "ProductConfigurationMasterDataType";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['type' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(ProductConfigurationMasterDataType::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}