...
class ProductConfigurationUnitType {
    const COLLECTION_NAME = "ProductConfigurationUnitType";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['unittypecode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(ProductConfigurationUnitType::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}