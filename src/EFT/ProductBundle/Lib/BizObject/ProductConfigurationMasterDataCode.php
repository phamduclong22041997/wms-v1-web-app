...
class ProductConfigurationMasterDataCode {
    const COLLECTION_NAME = "ProductConfigurationMasterDataCode";
    ...
    {
        return MongoDBManager::getCollection(ProductConfigurationMasterDataCode::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}