...
class ClientType {
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['clienttypecode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(ClientType::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}