...
namespace EFT\ReasonBundle\Lib\BizObject;
...
class ReasonForCancelPO {
    const COLLECTION_NAME = "ReasonForCancelPO";
    ...
    public function loadDocument($data) 
    {
        ...
        if($ref == "") {
            ...
            $this->document = $this->getCollection()->findOne(['reasoncode' => $ref, 'isdeleted' => 0]);
        }
    ...
    {
        return MongoDBManager::getCollection(ReasonForCancelPO::COLLECTION_NAME, Configuration::$CONNECTION);
    }
}