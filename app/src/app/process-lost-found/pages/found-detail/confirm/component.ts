...
export class ConfirmCancelFoundIssueComponent implements OnInit, AfterViewInit {
  info: any;
  cancelNote: String;

  @ViewChild('content', { static: false }) content: any;

  constructor(public dialogRef: MatDialogRef<ConfirmCancelFoundIssueComponent>,
