...
@Component({
  selector: "app-lostfound-mapping-session-details",
  templateUrl: "./component.html",
  styleUrls: ["./component.css"],
})
export class MappingLostFoundSessionDetailsComponent implements OnInit, AfterViewInit {
  ...
  getSessionMaching() {
    this.service.getSessionMaching({ SessionCode: this.code })
      .subscribe((resp: any) => {
