...
import { SO_STATUS, DOCUMENT_OBJECTTYPE, DOCUMENT_TYPE, CONFIRMQTY, NUMBERIC } from '../../../shared/constant';
...
export class SOPackingComponent implements OnInit, AfterViewInit {
  ...
  async onClickPrintInventoryDeliveryByPacking(isResetPage = 0){
    ...
    const dataPrint = this.printService.repairMultiInventoryDeliveryPacking([data])
